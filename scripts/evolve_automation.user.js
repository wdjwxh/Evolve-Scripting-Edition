...
(function ($) {
  ...
  var state = {
    ...
    evolutions: {
      ...
      Valdi: new EvolutionAction("", "evo", "junker", ""),
      // junker challenge
      ...
      Aquatic: new EvolutionAction("", "evo", "aquatic", ""),
      // ocean only
