...
export function index(){
    ...
    $('body').append(`<div id="topBar" class="topBar">
        ...
        <span class="version"><a href="https://github.com/wdjwxh/Evolve-Scripting-Edition/blob/master/changelog.md" target="_blank"></a></span>
    ...
    // Bottom Bar
    $('body').append(`<div class="promoBar"><span class="left"><a href="https://github.com/wdjwxh/Evolve-Scripting-Edition/blob/master/README.md" target="_blank"><h1>Unsupported Scripting Edition</h1></span></a><span class="right"><h2 class="is-sr-only">External Links</h2><a href="https://shimo.im/sheets/tg6VPQgCKhrYW9QG/" target="_blank" style="color: green;">最全中文Wiki</a>|<a href="https://pmotschmann.github.io/Evolve/" target="_blank">Original Evolve Idle Game</a> | <a href="https://github.com/pmotschmann/Evolve" target="_blank">Demagorddon GitHub</a> | <a href="https://www.patreon.com/demagorddon" target="_blank">Demagorddon Patreon</a> | <a href="https://www.paypal.com/cgi-bin/webscr?cmd=_donations&business=PTRJZBW9J662C&currency_code=USD&source=url" target="_blank">Donate to Demagorddon</a></span></div>`);
}
